...
namespace OpenCMIS.Module.Core.Tests
{
    public sealed class MsaMemoryAccessorTests
    {
        ...
        public async Task Read_rejects_range_past_end_of_page()
        {
            ...
            await Assert.ThrowsAsync<ArgumentOutOfRangeException>(() => accessor.ReadAsync(
                                                                          Address,
                                                                          new (0),
                                                                          new (0xFF),
                                                                          2).AsTask());
        ...
        public async Task Read_reports_page_selection_failure()
        {
            ...
            var error = await Assert.ThrowsAsync<CmisException>(() => accessor.ReadAsync(
                                                                        Address,
                                                                        new (0x11),
                                                                        Offset,
                                                                        1).AsTask());
        ...
        public async Task Read_propagates_caller_cancellation()
        {
            ...
            await Assert.ThrowsAnyAsync<OperationCanceledException>(() => accessor.ReadAsync(
                                                                            Address,
                                                                            new (0x11),
                                                                            Offset,
                                                                            1,
