...
internal sealed record SerialSessionScript(
    byte[] Response,
    Exception? WriteException = null,
    Exception? ReadException = null);

internal sealed class ScriptedSerialSessionFactory(
    params SerialSessionScript[] scripts) : ISerialSessionFactory
{
...
internal sealed class ScriptedSerialSession(
    SerialSessionScript script,
