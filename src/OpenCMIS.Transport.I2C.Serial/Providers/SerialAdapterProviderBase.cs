...
{
    protected SerialAdapterProviderBase(
    ...
    public abstract ValueTask<IReadOnlyList<I2cAdapterDescriptor>> DiscoverAsync(
        CancellationToken cancellationToken = default);

    public abstract ValueTask<II2cRegisterBus> OpenAsync(
        I2cConnectionProfile profile,
        CancellationToken cancellationToken = default);

    protected TProfile RequireProfile<TProfile>(
        I2cConnectionProfile profile)
