...
namespace OpenCMIS.Transport.I2C.Serial.Providers
{
    ...
    {
        public HmMultiChannelAdapterProvider(ISerialSessionFactory sessionFactory,
        ...
        public override ValueTask<IReadOnlyList<I2cAdapterDescriptor>> DiscoverAsync(CancellationToken cancellationToken = default)
        {
        ...
        public override async ValueTask<II2cRegisterBus> OpenAsync(I2cConnectionProfile profile,
