...
namespace OpenCMIS.Transport.I2C.Serial.Adapters
{
    ...
    {
        private static readonly byte[] ReadCommands = [0xE2, 0xE4, 0xD3, 0xE6, 0xE8];

        private static readonly byte[] WriteCommands = [0xE1, 0xE3, 0xD2, 0xE5, 0xE7];

        private readonly byte _channel;

        public HmMultiChannelI2cAdapter(ISerialSessionFactory           sessionFactory,
