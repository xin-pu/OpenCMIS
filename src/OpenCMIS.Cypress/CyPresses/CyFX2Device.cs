...
namespace OpenCMIS.Cypress
{
    ...
    {
        private readonly byte[]    FwImage = new byte[Util.MaxFwSize];
        private readonly ArrayList VendAX  = new ();
        private readonly ArrayList list    = new ();
        private readonly ArrayList list1   = new ();
        private          ushort    ImageLen;
        private          ushort    FwOffset;
