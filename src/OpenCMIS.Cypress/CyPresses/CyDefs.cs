...
namespace OpenCMIS.Cypress
{
    ...
    public struct USB_BOS_SS_DEVICE_CAPABILITY
    {
        ...
        public ushort
                wSpeedsSuported; //low speed supported if set,full speed supported if set,high speed supported if set,super speed supported if set,15:4 nt used
    ...
    public enum FX3_FWDWNLOAD_MEDIA_TYPE
    {
        RAM = 1,
        I2CE2PROM,
        SPIFLASH
    ...
    public enum FX3_FWDWNLOAD_ERROR_CODE
    {
        ...
        INVALID_FILE,
        SPIFLASH_ERASE_FAILED,
        CORRUPT_FIRMWARE_IMAGE_FILE,
        EXCEED_IMAGE_LENGTH,
        I2CEEPROM_UNKNOWN_I2C_SIZE
    }
    ...
    public static class CyConst
    {
        ...
        internal static Guid CyGuid              = new ("{0xae18aa60, 0x7f6a, 0x11d4, {0x97, 0xdd, 0x0, 0x1, 0x2, 0x29, 0xb9, 0x59}}");
        internal static Guid DiskGuid            = new ("{0x53f56307, 0xb6bf, 0x11d0, {0x94, 0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b}}");
        internal static Guid CdGuid              = new ("{0x53f56308, 0xb6bf, 0x11d0, {0x94, 0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b}}");
        internal static Guid StorGuid            = new ("{0x4D36E965, 0xE325, 0x11CE, {0xBF, 0xC1, 0x08, 0x00, 0x2B, 0xE1, 0x03, 0x18}}");
        internal static Guid Customer_DriverGuid = new ("{0x00000000, 0x0000, 0x0000, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}");
        internal static Guid Customer_ClassGuid  = new ("{0x00000000, 0x0000, 0x0000, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}");

        public static IntPtr INVALID_HANDLE = new (-1);
        ...
        public static   IntPtr DBT_DEVICEARRIVAL        = new (0x8000);
        public static   IntPtr DBT_DEVICEREMOVECOMPLETE = new (0x8004);
        internal static IntPtr DBT_DEVNODES_CHANGED     = new (0x0007);
        internal static IntPtr PBT_APMRESUMEAUTOMATIC   = new (0x0012);
        internal static IntPtr PBT_APMSUSPEND           = new (0x0004);
