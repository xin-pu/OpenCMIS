...
namespace OpenCMIS.App.Core.Services
{
    internal sealed class CmisMonitorReader(IRegisterAccess registers)
    {
            ...
            var result = new ModuleMonitors
                         {
                             Temperature = BuildMonitorValue(
                                     ...
                                     "°C",
                                     tempHighAlarmBytes,
                                     ParseTemperature(tempHighAlarmBytes),
                                     tempLowAlarmBytes,
                                     ParseTemperature(tempLowAlarmBytes),
                                     tempHighWarnBytes,
                                     ParseTemperature(tempHighWarnBytes),
                                     tempLowWarnBytes,
                                     ParseTemperature(tempLowWarnBytes)),
                             VCC = BuildMonitorValue(
                                     vccBytes,
                                     vccValue,
                                     "V",
                                     vccHighAlarmBytes,
                                     ParseVcc(vccHighAlarmBytes),
                                     vccLowAlarmBytes,
                                     ParseVcc(vccLowAlarmBytes),
                                     vccHighWarnBytes,
                                     ParseVcc(vccHighWarnBytes),
                                     vccLowWarnUnavailable,
                                     0,
                                     false)
                         };
        ...
        private static MonitorValue BuildMonitorValue(byte[] rawBytes,
                                                      double value,
                                                      string unit,
                                                      byte[] alarmHighRaw,
                                                      double alarmHigh,
