...
namespace OpenCMIS.App.Core
{
    ...
    public sealed class DeviceManager : IDeviceManager
    {
        ...
        public DeviceManager(IEnumerable<II2cAdapterProvider> providers,
        ...
        public async Task<IEnumerable<DeviceInfo>> EnumerateDevicesAsync()
        {
            ...
            foreach (var provider in _providers.Values)
                try
                {
                    ...
                    devices.AddRange(
                            descriptors.Select(descriptor => new DeviceInfo
                                                             {
        ...
        private static Dictionary<string, string> ToLegacyParameters(I2cConnectionProfile profile)
        {
