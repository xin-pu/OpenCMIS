...
namespace OpenCMIS.Module.Core.Hci
{
    ...
    public sealed class HciMemoryAccessor : IHciMemoryAccessor
    {
        ...
        public HciMemoryAccessor(OpticalModuleSession session,
                                 HciOptions           options,
        ...
        private async ValueTask ExecuteCommandAsync(II2cRegisterBus      bus,
        ...
        private async ValueTask WaitForReadyAsync(II2cRegisterBus   bus,
                                                  I2cDeviceAddress  device,
                                                  CancellationToken cancellationToken)
        {
