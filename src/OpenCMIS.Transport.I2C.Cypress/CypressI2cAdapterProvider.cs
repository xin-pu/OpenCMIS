...
{
    public sealed class CypressI2cAdapterProvider(ICypressDeviceApiFactory apiFactory) : II2cAdapterProvider
    {
        ...
        public async ValueTask<IReadOnlyList<I2cAdapterDescriptor>> DiscoverAsync(CancellationToken cancellationToken = default)
        {
        ...
        public async ValueTask<II2cRegisterBus> OpenAsync(I2cConnectionProfile profile,
        ...
        private async ValueTask<CypressDeviceKind?> FindDeviceKindAsync(string            serialNumber,
