namespace OpenCMIS.Transport.Abstractions
{
    ...
    {
        protected I2cConnectionProfile(string           adapterId,
    ...
    {
        public SerialI2cConnectionProfile(string           adapterId,
                                          string           portName,
                                          int              baudRate,
                                          I2cDeviceAddress deviceAddress)
    ...
    {
        public HmMultiChannelConnectionProfile(string           adapterId,
                                               string           portName,
                                               int              baudRate,
                                               byte             channel,
                                               I2cDeviceAddress deviceAddress)
    ...
    {
        public CypressI2cConnectionProfile(string           adapterId,
                                           string           serialNumber,
                                           int              port,
                                           int              speedKhz,
                                           I2cDeviceAddress deviceAddress)
